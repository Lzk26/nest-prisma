...
import { Task } from './entities/task.entiti';
  ...
  private tasks: Task[] = [
    {
      ...
      description:
        'Estudar as videos aulas de introdução a metodologia TDD - muito importante para a carreira',
      completed: false,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        'Separar responsabilidades entre controller e service seguindo boas práticas',
      completed: false,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        'Validar todos os endpoints utilizando ferramentas de teste de API',
      completed: false,
    },
  ];
